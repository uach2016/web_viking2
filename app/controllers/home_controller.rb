class HomeController < ShopifyApp::AuthenticatedController
  ...
  def upgrade_plan
    ...
    # @new_plan = Plan.new 
    plan = Plan.find()
    @plan = Plan.update_all(name: "Premiun") 
    binding.pry 
    @plan.price = 19.95
    @plan.description = "1 website, Full report, Monthly reports, Auto submit to Social Media, Daily scan of competitor websites, Customisable reports, Marketing Stats and Metrics, Website Results Tool, Personalised Marketing Plan, Step by step guide to improve your website, Steps explained in detail, Checklist of to do and completed issues, Cancel at any time"
